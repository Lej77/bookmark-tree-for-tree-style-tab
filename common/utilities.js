 ...
 *
 * @export
 * @returns {Promise<{promise: Promise<any>, resolve: function, reject: function}>} An object that wraps a promise and its resolve and reject functions.
 */
 ...
 * @param {Object | Object[]} values Array of values to set for each key. If shorter then key array then the rest are set to the default value.
